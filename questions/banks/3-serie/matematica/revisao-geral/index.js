...
const blocos = [
  {
    subtopico: "Funcoes e graficos",
    habilidade: "integrar conceitos de funcoes em revisao",
    tags: ["revisao", "funcoes"],
    fatos: [
      { lead: "uma funcao", answer: "a relacao que associa a cada elemento do dominio um unico elemento da imagem", why: "essa unicidade define o conceito formal" },
      { lead: "o grafico de uma funcao", answer: "a representacao no plano cartesiano dos pares ordenados da relacao", why: "ele permite interpretar comportamento e variacao" },
      { lead: "o dominio de uma funcao", answer: "o conjunto de valores permitidos para a variavel independente", why: "ele precisa ser analisado antes de resolver problemas" },
      { lead: "a imagem de uma funcao", answer: "o conjunto de valores efetivamente assumidos pela variavel dependente", why: "ela descreve os resultados produzidos pela regra" },
      { lead: "a taxa de variacao", answer: "a medida de como a saida se altera quando a entrada muda", why: "esse conceito aparece em varios tipos de funcao" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "uma inequacao", answer: "a sentenca matematica que compara expressoes por desigualdade", why: "o objetivo e encontrar o conjunto de valores que a satisfaz" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "um triangulo retangulo", answer: "o triangulo que possui um angulo de 90 graus", why: "ele permite aplicar o teorema de Pitagoras" },
      { lead: "o teorema de Pitagoras", answer: "a relacao que iguala o quadrado da hipotenusa a soma dos quadrados dos catetos", why: "essa e uma das bases da geometria plana" },
      { lead: "a semelhanca de triangulos", answer: "a correspondencia entre figuras de mesma forma com lados proporcionais", why: "ela permite calcular medidas por proporcao" }
    ]
  },
  {
  ...
  },
  {
    ...
    habilidade: "retomar razoes e funcoes trigonometricas",
    tags: ["revisao", "trigonometria"],
    fatos: [
      { lead: "o seno", answer: "a razao entre cateto oposto e hipotenusa no triangulo retangulo", why: "essa definicao basica sustenta a funcao seno" },
      { lead: "o cosseno", answer: "a razao entre cateto adjacente e hipotenusa no triangulo retangulo", why: "essa definicao basica sustenta a funcao cosseno" },
      { lead: "a tangente", answer: "a razao entre cateto oposto e cateto adjacente", why: "ela tambem pode ser vista como seno sobre cosseno" },
      { lead: "a circunferencia trigonometrica", answer: "a circunferencia de raio 1 usada para estudar angulos e funcoes", why: "ela amplia a trigonometria para todos os quadrantes" },
      { lead: "a periodicidade trigonometrica", answer: "a repeticao regular dos valores das funcoes apos certo intervalo angular", why: "esse comportamento aparece em seno, cosseno e tangente" }
    ]
  },
  {
    subtopico: "Analise combinatoria e probabilidade",
    ...
    fatos: [
      ...
      { lead: "uma combinacao", answer: "a selecao de elementos em que a ordem nao importa", why: "esse criterio distingue combinacao de arranjo" },
      { lead: "a probabilidade de um evento", answer: "a razao entre casos favoraveis e casos possiveis em um espaco equiprovavel", why: "essa e a definicao classica mais usada" },
      { lead: "eventos complementares", answer: "eventos cujas probabilidades somam 1", why: "quando um ocorre o outro necessariamente nao ocorre" }
    ]
  },
  {
    subtopico: "Estatistica",
    habilidade: "revisar leitura e analise de dados",
    tags: ["revisao", "estatistica"],
    fatos: [
      { lead: "a media aritmetica", answer: "o quociente entre a soma dos valores e a quantidade de dados", why: "ela resume um conjunto por um valor central" },
      ...
      { lead: "a moda", answer: "o valor que ocorre com maior frequencia", why: "ela destaca a repeticao em um conjunto de dados" },
      { lead: "o desvio padrao", answer: "a medida de dispersao que indica o afastamento medio em relacao a media", why: "ele ajuda a comparar regularidade entre conjuntos" },
      { lead: "a interpretacao de graficos", answer: "a leitura critica de tendencias, frequencias e comparacoes entre dados", why: "essa habilidade e central no ENEM e em vestibulares" }
    ]
  },
  {
    subtopico: "Funcoes exponenciais e logaritmos",
    habilidade: "integrar exponenciais e logaritmos em revisao",
    tags: ["revisao", "exponencial", "logaritmo"],
    fatos: [
      { lead: "uma funcao exponencial", answer: "a funcao em que a variavel aparece no expoente", why: "ela modela crescimentos e decaimentos multiplicativos" },
  ...
  {
    subtopico: "Matematica financeira e porcentagem",
  ...
  {
    subtopico: "Interpretacao e modelagem",
    habilidade: "integrar leitura de enunciados e modelagem matematica",
    tags: ["revisao", "modelagem", "interpretacao"],
    fatos: [
      { lead: "a modelagem matematica", answer: "a traducao de uma situacao real para linguagem matematica", why: "ela permite escolher formulas e estrategias adequadas" },
      ...
      { lead: "a interpretacao final", answer: "a leitura do resultado numerico no contexto pedido pela questao", why: "o objetivo final e responder a situacao, nao apenas obter um numero" }
    ]
  }
];
...
export const revisaoGeral = createMathematicsTopic({
  ...
  habilidadesBase: [
    "integrar conceitos de algebra, geometria e funcoes",
    "retomar contagem, probabilidade e estatistica",
    "aplicar matematica financeira e proporcionalidade",
    "interpretar graficos, tabelas e enunciados contextualizados",
