...
const blocos = [
  {
    subtopico: "Conceito de química organica",
    habilidade:
      "identificar o objeto de estudo e os fundamentos da química organica",
    tags: ["química organica", "carbono", "compostos organicos"],
    fatos: [
      { lead: "a química organica", answer: "o ramo da química que estuda principalmente compostos de carbono", why: "esse elemento forma enorme variedade de estruturas e substancias" },
      { lead: "o carbono nos compostos organicos", answer: "o elemento central capaz de formar cadeias e ligacoes variadas", why: "sua tetravalencia amplia muito o número de compostos possíveis" },
      { lead: "o objeto de estudo da química organica", answer: "as estruturas, propriedades e transformacoes dos compostos carbonados", why: "ela investiga desde combustiveis ate biomoleculas" },
  ...
  },
  {
    ...
    habilidade:
      "classificar cadeias carbonicas segundo critérios estruturais",
    tags: ["cadeias carbonicas", "aberta", "fechada"],
    fatos: [
      { lead: "uma cadeia aberta", answer: "a cadeia carbonica que não forma ciclo", why: "ela também pode ser chamada de aciclica" },
      ...
      { lead: "uma cadeia saturada", answer: "a cadeia que possui apenas ligacoes simples entre carbonos", why: "não ha ligacoes duplas ou triplas entre atomos de carbono" },
      ...
      { lead: "uma cadeia ramificada", answer: "a cadeia que apresenta desvios laterais em relação a sequencia principal", why: "ela não segue apenas uma linha continua simples" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "um carbono primario", answer: "o carbono ligado diretamente a apenas outro carbono", why: "essa classificacao depende do número de carbonos vizinhos" },
      ...
      { lead: "um carbono terciario", answer: "o carbono ligado diretamente a tres outros carbonos", why: "essa situação e comum em estruturas ramificadas" },
      ...
      { lead: "a classificacao dos carbonos", answer: "o critério baseado no número de atomos de carbono diretamente vizinhos", why: "ela ajuda a descrever a estrutura das moleculas" }
    ]
  },
  {
  ...
  },
  {
    ...
    fatos: [
      { lead: "o prefixo da nomenclatura organica", answer: "a parte do nome que indica o número de carbonos da cadeia principal", why: "met-, et-, prop- e but- são exemplos usuais" },
      ...
      { lead: "o sufixo da nomenclatura organica", answer: "a parte do nome que identifica a função organica principal", why: "ele diferencia classes como alcool, aldeido e acido" },
      { lead: "a cadeia principal", answer: "a sequencia de carbonos escolhida como referencia para nomear a molecula", why: "ela deve seguir critérios de comprimento e prioridade" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "a isomeria plana", answer: "a situação em que compostos possuem mesma formula molecular e estruturas diferentes no plano", why: "eles diferem no arranjo dos atomos" },
      ...
      { lead: "a isomeria de função", answer: "a situação em que compostos de mesma formula pertencem a funções organicas diferentes", why: "a mudanca estrutural altera o comportamento quimico" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a importancia dos combustiveis organicos", answer: "o fornecimento de energia para transporte, industria e atividades cotidianas", why: "a química organica esta diretamente ligada a essa matriz" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o etanol combustivel", answer: "o alcool obtido por fermentacao ou outras rotas e usado como fonte de energia", why: "ele é um importante biocombustivel" },
      ...
      { lead: "a relação entre química organica e energia", answer: "o estudo dos compostos de carbono presentes em combustiveis e materiais energeticos", why: "a organica ajuda a compreender composicao e uso dessas substancias" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a reacao de combustao organica", answer: "a oxidacao energetica de compostos carbonados com produção de calor", why: "ela é importante para combustiveis" },
      { lead: "a reatividade de uma insaturacao", answer: "a maior facilidade de participar de certas reacoes como adicao", why: "ligacoes multiplas são centros reativos relevantes" },
      { lead: "o estudo introdutorio das reacoes organicas", answer: "a observação de transformacoes tipicas ligadas a estrutura da cadeia e do grupo funcional", why: "isso prepara a compreensao de sinteses e usos" }
    ]
  },
  {
    subtopico: "Química organica e cotidiano",
    habilidade:
      "aplicar conceitos de química organica a materiais e situações cotidianas",
    ...
    fatos: [
      ...
      { lead: "a relação entre alimentos e organica", answer: "o fato de carboidratos, lipidios e proteinas serem compostos carbonados", why: "biomoleculas pertencem ao dominio da química organica" },
      ...
      { lead: "a utilidade de estudar química organica", answer: "a compreensao das substancias de carbono presentes em processos naturais e tecnologicos", why: "isso aproxima a disciplina de temas amplamente vividos" }
    ]
  }
];
