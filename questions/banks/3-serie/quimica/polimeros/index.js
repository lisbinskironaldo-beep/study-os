...
const blocos = [
  {
    ...
    fatos: [
      ...
      { lead: "uma macromolecula", answer: "a molecula de grande massa molecular resultante da uniao de muitas unidades", why: "esse é um traco marcante dos polimeros" },
      { lead: "a polimerizacao", answer: "o processo quimico de formação de polimeros a partir de monomeros", why: "ela converte pequenas moleculas em grandes cadeias" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "a polimerizacao por adicao", answer: "a formação de polimeros pela abertura de ligacoes multiplas dos monomeros", why: "muitos alcenos originam polimeros por esse mecanismo" },
      ...
      { lead: "o polietileno", answer: "um polimero obtido a partir da polimerizacao do eteno", why: "ele é um exemplo classico de polimero de adicao" },
      { lead: "a manutencao da composicao basica na adicao", answer: "a ausencia de subproduto pequeno na formação do polimero", why: "os atomos do monomero entram praticamente todos na cadeia" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "a polimerizacao por condensacao", answer: "a formação de polimeros com eliminacao de pequenas moleculas como agua", why: "o encadeamento ocorre acompanhado de subproduto" },
      ...
      { lead: "a diferenca entre adicao e condensacao", answer: "o fato de a condensacao liberar subproduto e a adicao não", why: "essa é a comparacao mais basica entre os mecanismos" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "um polimero natural", answer: "o polimero produzido por seres vivos ou presente em materiais naturais", why: "celulose e proteinas são exemplos importantes" },
      ...
      { lead: "o amido", answer: "um polimero natural de reserva energetica em plantas", why: "ele também resulta de repeticoes de unidades de glicose" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "o PVC", answer: "um polimero sintetico obtido a partir do cloreto de vinila", why: "ele é muito usado em tubos e revestimentos" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "um termoplastico", answer: "o polimero que pode amolecer e ser remoldado quando aquecido", why: "sua estrutura permite reprocessamento em muitas situações" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "um elastomero", answer: "o polimero com alta elasticidade e capacidade de deformar-se e voltar ao formato inicial", why: "borrachas são exemplos tipicos dessa classe" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a função dos estabilizantes", answer: "a protecao do polimero contra degradacao por calor, luz ou oxigenio", why: "eles aumentam durabilidade do produto" },
      { lead: "a função dos corantes em polimeros", answer: "a modificacao estetica do material produzido", why: "eles atendem exigencias visuais e comerciais" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a reciclagem de polimeros", answer: "o reaproveitamento de materiais plastificados para reduzir residuos e consumo de recursos", why: "ela é uma estrategia importante de gestao ambiental" },
      ...
      { lead: "a educação ambiental sobre polimeros", answer: "a conscientizacao sobre consumo, descarte e reaproveitamento de materiais", why: "ela ajuda a enfrentar o problema dos residuos" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "os polimeros nas embalagens", answer: "a aplicacao de materiais leves, moldaveis e resistentes para acondicionar produtos", why: "essa é uma das utilizacoes mais difundidas dos plasticos" },
      ...
      { lead: "os polimeros na industria textil", answer: "a presenca de fibras sinteticas em roupas e tecidos", why: "poliester e nylon são exemplos marcantes" },
      ...
      { lead: "a relevancia dos polimeros no cotidiano", answer: "a presenca ampla desses materiais em objetos, equipamentos e processos modernos", why: "eles combinam propriedades variadas com produção em larga escala" }
    ]
  }
];
