...
const blocos = [
  {
    ...
    habilidade:
      "integrar diferentes frentes da biologia em situações de revisao",
    tags: ["citologia", "metabolismo", "celula"],
    fatos: [
      { lead: "a membrana plasmatica", answer: "a estrutura que delimita a célula e controla trocas com o meio", why: "ela participa da homeostase celular" },
      { lead: "a mitocondria", answer: "a organela associada a respiracao celular e produção de ATP", why: "ela é central no metabolismo energetico" },
      { lead: "a fotossintese", answer: "o processo de produção de materia organica a partir de luz, agua e gas carbonico", why: "ele ocorre em organismos autotrofos e conecta biologia celular e ecologia" },
      { lead: "o ATP", answer: "a molecula que atua como moeda energetica da célula", why: "ela armazena e transfere energia para varios processos metabolicos" },
      { lead: "o metabolismo celular", answer: "o conjunto de reacoes quimicas que sustentam o funcionamento da célula", why: "ele inclui sintese, degradacao e obtencao de energia" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o DNA como material genetico", answer: "a molecula que armazena e transmite a informacao hereditaria", why: "ela é base da heranca biologica" },
      { lead: "a segregacao dos alelos", answer: "a separacao dos fatores hereditarios durante a formação dos gametas", why: "esse principio esta ligado a genetica mendeliana" },
      { lead: "a mutacao genetica", answer: "a alteracao na sequencia do material genetico que pode gerar variabilidade", why: "ela é fonte de novas combinacoes biologicas" },
      { lead: "o heredograma", answer: "o esquema gráfico utilizado para analisar padroes de heranca em familias", why: "ele conecta genetica e interpretação de casos humanos" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "o DNA recombinante", answer: "a molecula formada por fragmentos de DNA de diferentes origens", why: "ela é ferramenta central da engenharia genetica" },
      { lead: "o organismo transgenico", answer: "o ser vivo que recebeu gene proveniente de outra especie", why: "ele é um caso particular de OGM" },
      { lead: "a clonagem", answer: "a produção de copias geneticamente muito semelhantes de genes, células ou organismos", why: "ela possui aplicacoes cientificas e debates eticos" },
      { lead: "as células-tronco", answer: "as células capazes de autorrenovacao e diferenciacao em outros tipos celulares", why: "elas tem grande relevancia medica e biotecnologica" },
      { lead: "a bioetica", answer: "a reflexão sobre limites e responsabilidades no uso de técnicas biologicas", why: "ela orienta debates sobre biotecnologia e saude" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "a selecao natural", answer: "o processo em que características vantajosas tendem a tornar-se mais frequentes na populacao", why: "ela é um mecanismo central da evolucao" },
      ...
      { lead: "a especiacao", answer: "o processo de formação de novas especies", why: "ela amplia a diversidade biologica ao longo do tempo" },
      { lead: "a variabilidade genetica", answer: "a diversidade de genes e combinacoes entre individuos de uma populacao", why: "ela sustenta a ação da evolucao" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "o ciclo do nitrogenio", answer: "a transformacao e circulacao do nitrogenio entre ambiente e seres vivos", why: "ele depende fortemente da ação de micro-organismos" },
      ...
      { lead: "a interferencia humana nos ciclos", answer: "a alteracao dos fluxos naturais por ações como desmatamento e emissao de poluentes", why: "isso pode gerar desequilibrios ambientais" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a sustentabilidade", answer: "a busca de equilíbrio entre uso dos recursos e manutencao das condicoes ambientais", why: "ela orienta praticas de longo prazo" },
      { lead: "a educação ambiental", answer: "o processo de formação critica voltado a compreensao e enfrentamento de problemas ecologicos", why: "ela contribui para participacao social e mudanca de praticas" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "a homeostase", answer: "a manutencao do equilíbrio interno do organismo", why: "ela depende da integracao entre varios sistemas fisiologicos" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a diversidade animal", answer: "a variedade de grupos com diferentes planos corporais, habitats e modos de vida", why: "ela é resultado de processos evolutivos longos" },
  ...
  {
    subtopico: "Interpretação de gráficos, experimentos e questoes integradas",
    habilidade:
      "interpretar textos, tabelas, gráficos e experimentos biologicos",
    tags: ["graficos", "experimentos", "interpretacao"],
    fatos: [
      { lead: "a leitura de um gráfico biologico", answer: "a análise de variaveis, tendencias e relações representadas visualmente", why: "ela é essencial em questoes integradas e no enem" },
      { lead: "a interpretação de um experimento biologico", answer: "a identificacao de problema, hipotese, variaveis e resultado obtido", why: "essa leitura liga metodo cientifico e conteudo" },
      { lead: "a questao integrada de biologia", answer: "o item que relaciona diferentes frentes do conteudo em uma mesma situação-problema", why: "ela exige articulacao e não apenas memorizacao" },
      ...
      { lead: "a revisao final em biologia", answer: "a sintese articulada de conceitos de varias areas da disciplina para resolver problemas amplos", why: "ela prepara o estudante para interpretação e conexao de temas" }
    ]
  }
];
...
export const revisaoGeral = {
  ...
  metadados: {
    ...
    subtopicosBase: [
      ...
      "Interpretação de gráficos, experimentos e questoes integradas"
    ],
    habilidadesBase: [
      "integrar diferentes frentes da biologia em situações de revisao",
      "interpretar textos, tabelas, gráficos e experimentos biologicos",
