...
const blocos = [
  {
    ...
    fatos: [
      { lead: "a ecologia", answer: "a area da biologia que estuda as relações dos seres vivos entre si e com o ambiente", why: "ela analisa interacoes em diferentes niveis de organizacao" },
      ...
      { lead: "o fator abiotico", answer: "o componente não vivo do ambiente, como agua, luz e temperatura", why: "essas condicoes limitam e regulam a vida" },
      { lead: "a importancia da ecologia", answer: "a compreensao do funcionamento dos ecossistemas e do equilíbrio ambiental", why: "ela conecta biologia, conservacao e sustentabilidade" }
    ]
  },
  {
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a teia alimentar", answer: "o conjunto de cadeias alimentares interligadas em um ecossistema", why: "na natureza as relações alimentares são mais complexas que uma cadeia unica" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a piramide de números", answer: "a representacao da quantidade de individuos em cada nivel trofico", why: "ela pode apresentar formatos diferentes conforme as especies envolvidas" },
      { lead: "a diminuicao de energia entre niveis troficos", answer: "a perda de parte da energia na forma de calor e metabolismo", why: "isso limita o número de niveis em uma cadeia" },
  ...
  {
    subtopico: "Relações ecologicas intraespecificas",
    habilidade:
      "diferenciar relações ecologicas, nicho, habitat e fatores ambientais",
    tags: ["intraespecificas", "sociedade", "colonia"],
    fatos: [
      { lead: "a relação intraespecifica", answer: "a interacao ecologica entre individuos da mesma especie", why: "ela pode ser harmonica ou desarmonica" },
      { lead: "a colonia", answer: "a associacao entre individuos da mesma especie unidos fisicamente ou muito integrados", why: "esse é um tipo de relação intraespecifica harmonica" },
      { lead: "a sociedade", answer: "a associacao entre individuos da mesma especie com divisao de trabalho sem uniao física permanente", why: "abelhas e formigas são exemplos classicos" },
      { lead: "a competicao intraespecifica", answer: "a disputa entre individuos da mesma especie por recursos limitados", why: "ela ocorre quando alimento, espaco ou parceiros são insuficientes" },
      { lead: "o canibalismo", answer: "a relação desarmonica em que um individuo se alimenta de outro da mesma especie", why: "esse fenomeno pode ocorrer em diversos grupos animais" }
    ]
  },
  {
    subtopico: "Relações ecologicas interespecificas",
    habilidade:
      "diferenciar relações ecologicas, nicho, habitat e fatores ambientais",
    tags: ["interespecificas", "predacao", "mutualismo"],
    fatos: [
      { lead: "a relação interespecifica", answer: "a interacao ecologica entre individuos de especies diferentes", why: "ela pode gerar beneficios, prejuizos ou neutralidade relativa" },
      { lead: "o mutualismo", answer: "a relação harmonica em que ambas as especies se beneficiam", why: "em alguns casos a associacao e indispensavel a sobrevivencia" },
      { lead: "a predacao", answer: "a relação em que um organismo captura e mata outro para alimentar-se", why: "ela interfere na dinamica populacional das especies" },
      { lead: "o parasitismo", answer: "a relação em que uma especie vive as custas de outra causando-lhe prejuizo sem morte imediata", why: "o parasita depende do hospedeiro para obter recursos" },
      { lead: "o comensalismo", answer: "a relação em que uma especie se beneficia e a outra não sofre prejuizo significativo", why: "ela é considerada relação harmonica interespecifica" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o nicho ecologico", answer: "o papel funcional e o modo de vida de uma especie no ecossistema", why: "ele inclui uso de recursos e relações com outras especies" },
      { lead: "o habitat de uma especie", answer: "o lugar fisico em que ela vive", why: "habitat e nicho não são conceitos equivalentes" },
      ...
      { lead: "a sobreposicao de nichos", answer: "a situação em que especies usam recursos semelhantes e podem competir entre si", why: "ela influencia coexistencia ecologica" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "a densidade populacional", answer: "a relação entre número de individuos e area ou volume ocupado", why: "ela ajuda a comparar populacoes em diferentes espacos" },
      { lead: "o crescimento populacional", answer: "a variação no número de individuos de uma populacao ao longo do tempo", why: "ele depende de natalidade, mortalidade e migracoes" },
      { lead: "a capacidade de suporte", answer: "o número maximo de individuos que o ambiente consegue sustentar de forma estavel", why: "ela limita o crescimento populacional" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a comunidade climacica", answer: "a comunidade mais estavel ao final de um processo sucessional", why: "ela representa maior complexidade e equilíbrio relativo" },
  ...
  },
  {
    ...
    habilidade:
      "avaliar estrategias de conservacao e equilíbrio dos ecossistemas",
    tags: ["conservacao", "equilibrio", "preservacao"],
    fatos: [
      { lead: "a conservacao ambiental", answer: "o conjunto de ações voltadas a manutencao da biodiversidade e do funcionamento dos ecossistemas", why: "ela busca reduzir perdas e desequilibrios" },
      ...
      { lead: "a unidade de conservacao", answer: "a area criada para proteger ambientes, especies e processos naturais", why: "ela é instrumento importante de politica ambiental" },
      { lead: "o equilíbrio ecologico", answer: "a manutencao relativa do funcionamento das relações e fluxos em um ecossistema", why: "esse equilíbrio pode ser rompido por impactos intensos" },
...
export const ecologia = {
  ...
  metadados: {
    ...
    base: "ESCOLAR",
    eixo: "Biologia",
    frente: "Relações ecologicas e funcionamento dos ecossistemas",
    searchAliases: [
      "ecologia",
      "ecossistemas",
      "cadeia alimentar",
    ...
    subtopicosBase: [
      ...
      "Relações ecologicas intraespecificas",
      "Relações ecologicas interespecificas",
