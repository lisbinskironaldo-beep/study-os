...
const blocos = [
  {
    ...
    fatos: [
      ...
      { lead: "a importancia ecologica dos ciclos", answer: "a manutencao da disponibilidade de elementos essenciais a vida", why: "eles sustentam a produtividade e o equilíbrio dos ecossistemas" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a evaporacao", answer: "a passagem da agua liquida para o estado gasoso", why: "essa etapa contribui para a formação de vapor na atmosfera" },
      { lead: "a condensacao", answer: "a transformacao do vapor de agua em goticulas liquidas", why: "ela participa da formação de nuvens" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a fotossintese no ciclo do carbono", answer: "a retirada de gas carbonico da atmosfera para produção de materia organica", why: "esse processo incorpora carbono aos produtores" },
      ...
      { lead: "os reservatorios de carbono", answer: "os compartimentos onde o elemento pode permanecer armazenado, como oceanos, biomassa e combustiveis fosseis", why: "eles participam do equilíbrio do ciclo" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a amonificacao", answer: "a formação de compostos amoniacais a partir da decomposicao de materia organica nitrogenada", why: "ela reintroduz nitrogenio no solo" }
    ]
  },
  {
    subtopico: "Ciclo do fosforo",
    habilidade:
      "relacionar características e importancia do ciclo do fosforo e de outros nutrientes",
    tags: ["fosforo", "solo", "nutrientes"],
    fatos: [
      { lead: "o ciclo do fosforo", answer: "a circulacao do fosforo principalmente entre rochas, solo, agua e seres vivos", why: "ele não possui fase atmosferica expressiva como outros ciclos" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a produção de oxigenio pela fotossintese", answer: "a liberacao de O2 durante a sintese de materia organica por organismos autotrofos", why: "essa etapa reabastece a atmosfera" },
      ...
      { lead: "a relação entre oxigenio e equilíbrio atmosferico", answer: "a manutencao de concentracoes adequadas pela integracao entre processos biologicos e quimicos", why: "isso influencia a vida no planeta" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "os decompositores", answer: "os organismos que degradam materia organica morta liberando substancias reutilizaveis", why: "fungos e bacterias são essenciais nesse processo" },
      ...
      { lead: "a reciclagem de nutrientes", answer: "o retorno de elementos quimicos ao solo, agua e atmosfera por ação biologica", why: "sem isso os ecossistemas perderiam fertilidade" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "a queima de combustiveis fosseis", answer: "a atividade humana que intensifica a liberacao de carbono para a atmosfera", why: "ela altera o equilíbrio do ciclo do carbono" },
      ...
      { lead: "o desmatamento", answer: "a ação que reduz a fixacao de carbono pela vegetacao e altera o ciclo da agua", why: "ele afeta varios ciclos simultaneamente" },
      ...
      { lead: "a intensificacao antropica dos ciclos", answer: "a mudanca provocada por ações humanas em taxas e fluxos naturais de elementos", why: "essa interferencia pode gerar impactos ambientais amplos" }
    ]
  },
  {
    subtopico: "Ciclos biogeoquimicos e equilíbrio ecologico",
    habilidade:
      "avaliar alteracoes humanas nos ciclos biogeoquimicos e seus impactos",
    tags: ["equilíbrio ecologico", "ciclos", "ecossistemas"],
    fatos: [
      { lead: "o equilíbrio ecologico nos ciclos", answer: "a manutencao relativa da disponibilidade e circulacao dos elementos essenciais nos ecossistemas", why: "grandes alteracoes comprometem a estabilidade ambiental" },
      { lead: "a produtividade primaria e os ciclos", answer: "a dependencia da produção biologica em relação a disponibilidade de agua, carbono e nutrientes", why: "ciclos regulam a base energetica dos ecossistemas" },
      ...
      { lead: "a importancia dos ciclos para a vida", answer: "a reposição continua de elementos fundamentais como agua, carbono, nitrogenio e fosforo", why: "sem essa reposição a vida não se manteria" }
    ]
  },
  {
    subtopico: "Interpretação de situações ambientais",
    habilidade:
      "avaliar alteracoes humanas nos ciclos biogeoquimicos e seus impactos",
    tags: ["interpretacao", "problemas ambientais", "ciclos"],
    fatos: [
      { lead: "a leitura de um problema sobre ciclos biogeoquimicos", answer: "a identificacao do elemento envolvido, das etapas do ciclo e da alteracao ambiental descrita", why: "essa estrategia organiza a interpretação da questao" },
      { lead: "a relação entre eutrofizacao e nutrientes", answer: "o excesso de compostos de nitrogenio e fosforo em ambientes aquaticos", why: "essa entrada altera o equilíbrio do ecossistema" },
      { lead: "a interpretação de gráficos dos ciclos", answer: "a análise de fluxos, reservatorios e mudancas ao longo do tempo", why: "gráficos são comuns em avaliacoes de ecologia" },
      { lead: "a identificacao de um impacto no ciclo da agua", answer: "a observação de mudancas em infiltracao, evaporacao, escoamento ou precipitacao", why: "ações humanas podem alterar essas etapas" },
      { lead: "a utilidade do estudo dos ciclos", answer: "a compreensao integrada entre materia, ecossistemas e impactos ambientais", why: "ele é essencial para interpretar problemas ecologicos atuais" }
    ]
  }
];
...
export const ciclosBiogeoquimicos = {
  ...
  metadados: {
    ...
    base: "ESCOLAR",
    eixo: "Biologia",
    frente: "Ciclagem da materia e equilíbrio ambiental",
    searchAliases: [
    ...
    subtopicosBase: [
      ...
      "Ciclos biogeoquimicos e equilíbrio ecologico",
      "Interpretação de situações ambientais"
    ],
    habilidadesBase: [
      "identificar os principais ciclos biogeoquimicos e sua importancia ecologica",
      "compreender etapas e importancia dos ciclos da agua e do carbono",
