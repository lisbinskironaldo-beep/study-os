...
const blocos = [
  {
    ...
    fatos: [
      ...
      { lead: "o desequilibrio ecologico", answer: "a ruptura de relacoes e fluxos naturais em um ecossistema", why: "impactos intensos podem comprometer esse equilibrio" },
      { lead: "o recurso natural", answer: "o elemento do ambiente utilizado pelos seres humanos para diferentes finalidades", why: "agua, solo e biodiversidade sao exemplos classicos" },
      { lead: "a analise ambiental", answer: "a observacao das causas, consequencias e possibilidades de mitigacao dos impactos", why: "ela orienta politicas e acoes de conservacao" }
    ]
  },
  {
    subtopico: "Poluicao da agua",
    habilidade:
      "analisar relacoes entre poluicao, saude e equilibrio dos ecossistemas",
    ...
    fatos: [
      ...
      { lead: "a qualidade da agua", answer: "a condicao fisico-quimica e biologica de uma agua em relacao a seus usos e a vida aquatica", why: "ela se altera diante de poluentes" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a qualidade do ar", answer: "a condicao atmosferica em relacao a presenca e concentracao de poluentes", why: "ela influencia diretamente a saude coletiva" },
      { lead: "a relacao entre ar poluido e saude", answer: "o aumento do risco de doencas respiratorias e cardiovasculares em populacoes expostas", why: "a poluicao atmosferica tem forte impacto sanitario" }
    ]
  },
  {
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a relacao entre queimadas e emissao de gases", answer: "a liberacao de material particulado e carbono para a atmosfera", why: "isso agrava problemas locais e globais" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o efeito estufa natural", answer: "o fenomeno de retencao de parte do calor atmosferico por certos gases", why: "ele e importante para manter temperatura adequada a vida" },
      ...
      { lead: "o aquecimento global", answer: "a elevacao media da temperatura do planeta associada a mudancas na composicao atmosferica", why: "ele influencia clima, oceanos e ecossistemas" },
      ...
      { lead: "a mudanca climatica", answer: "a alteracao de padroes de temperatura, chuvas e eventos extremos ao longo do tempo", why: "ela pode ser intensificada pela acao humana" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a especie ameacada", answer: "o organismo com risco elevado de desaparecer em um horizonte temporal relevante", why: "sua situacao exige medidas de protecao" },
      { lead: "a conservacao da biodiversidade", answer: "o conjunto de estrategias voltadas a manutencao da diversidade biologica", why: "ela e essencial para o equilibrio ambiental e a vida humana" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a saude ambiental", answer: "a relacao entre condicoes do ambiente e bem-estar das populacoes humanas", why: "degradacao ambiental afeta diretamente a saude" },
      ...
      { lead: "o manejo adequado de residuos", answer: "a estrategia para reduzir poluicao e proliferacao de vetores", why: "ele e parte importante do saneamento" },
      { lead: "a prevencao ambiental em saude", answer: "o conjunto de acoes que reduz riscos ambientais a populacao", why: "ela depende de politicas publicas e educacao" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a mitigacao ambiental", answer: "as acoes destinadas a reduzir ou compensar impactos negativos ja identificados", why: "ela e importante em politicas e projetos de manejo" },
      ...
      { lead: "a educacao ambiental", answer: "o processo formativo voltado a compreensao critica das relacoes entre sociedade e natureza", why: "ela favorece participacao e mudanca de praticas" }
    ]
  },
  {
    subtopico: "Interpretacao de problemas ambientais",
    habilidade:
      "relacionar impactos ambientais a mudancas climaticas e ciclos biogeoquimicos",
    tags: ["interpretacao", "problemas ambientais", "analise"],
    fatos: [
      { lead: "a leitura de um problema ambiental", answer: "a identificacao do impacto, da causa, dos organismos afetados e das possiveis solucoes", why: "essa organizacao melhora a analise biologica" },
      { lead: "a interpretacao de graficos ambientais", answer: "a analise de tendencias em temperatura, poluentes, desmatamento ou biodiversidade", why: "dados visuais sao frequentes em questoes atuais" },
      { lead: "a relacao entre impacto local e efeito global", answer: "o vinculo entre alteracoes pontuais e consequencias amplas em ciclos e clima", why: "alguns problemas extrapolam a escala imediata" },
      { lead: "a analise de estudos de caso ambientais", answer: "a aplicacao de conceitos ecologicos e biogeoquimicos a situacoes concretas", why: "ela integra diferentes frentes da biologia" },
      { lead: "a utilidade do estudo dos impactos ambientais", answer: "a compreensao critica das relacoes entre atividade humana, ecossistemas e sustentabilidade", why: "isso e central para a formacao cientifica e cidada" }
    ]
  }
];
...
export const impactosAmbientais = {
  ...
  metadados: {
    ...
    subtopicosBase: [
      ...
      "Interpretacao de problemas ambientais"
    ],
    habilidadesBase: [
      "identificar tipos de impactos ambientais e seus efeitos ecologicos",
      "analisar relacoes entre poluicao, saude e equilibrio dos ecossistemas",
