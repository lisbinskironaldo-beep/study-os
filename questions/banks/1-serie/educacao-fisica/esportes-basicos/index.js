...
const blocos = [
    ...
    fatos: [
      {
        ...
        answer: "as habilidades elementares que sustentam a prática de uma modalidade",
        why: "sem esses fundamentos, a execucao técnica fica limitada"
      },
      {
        lead: "a iniciacao esportiva",
        answer: "o processo de aprendizagem inicial de regras, gestos e participação",
        why: "ela apresenta a modalidade de forma progressiva"
      },
      {
        lead: "a prática esportiva escolar",
        answer: "uma experiência educativa que prioriza aprendizagem e participação",
        why: "na escola, o esporte não se reduz ao rendimento competitivo"
      },
      {
        lead: "a habilidade motora basica",
        answer: "uma capacidade de movimento que apoia diferentes esportes",
        why: "correr, saltar e arremessar servem de base para várias modalidades"
      },
      {
  ...
  },
  {
    subtopico: "Atletismo",
    habilidade:
      "compreender regras e técnicas fundamentais",
    tags: ["atletismo", "corrida", "saltos"],
    fatos: [
      {
        lead: "o atletismo",
        answer: "um conjunto de modalidades baseadas em correr, saltar e lançar",
        why: "essas ações estao entre os movimentos mais fundamentais do esporte"
      },
      {
        lead: "as provas de corrida",
        answer: "modalidades de deslocamento em diferentes distâncias e ritmos",
        why: "elas desenvolvem velocidade, resistencia e estratégia"
      },
      {
        lead: "os saltos atleticos",
        answer: "provas em que o objetivo e projetar o corpo para superar distância ou altura",
        why: "nessas provas, técnica e impulsao são determinantes"
      },
      {
        lead: "os lançamentos",
        answer: "modalidades em que um implemento deve ser arremessado com técnica apropriada",
        why: "forca, coordenação e angulo de saida influenciam o resultado"
      },
      {
        lead: "a passada de corrida",
        answer: "a organização do apoio e da impulsao durante o deslocamento",
  ...
  },
  {
    ...
    fatos: [
      ...
      {
        lead: "o saque",
        answer: "a ação que coloca a bola em disputa no inicio do ponto",
  ...
  },
  {
    ...
    fatos: [
      ...
      {
        lead: "a marcacao",
        answer: "a ação defensiva de acompanhar adversarios e limitar jogadas",
    ...
    fatos: [
      {
        ...
        answer: "modalidades em que vence quem obtiver melhor tempo, distância ou peso",
      ...
      {
        lead: "a distância medida",
        answer: "o registro objetivo do alcance em saltos ou lançamentos",
        why: "essa medida define classificacao nas provas"
      },
      {
        lead: "o desempenho progressivo",
        answer: "a melhora gradual dos resultados com treino e técnica",
    ...
    fatos: [
      {
        ...
        why: "nessas práticas, exatidao vale mais que velocidade pura"
      },
      {
      ...
      },
      {
        ...
        why: "atenção e regularidade influenciam o acerto"
      },
      {
    ...
    fatos: [
      {
        ...
        answer: "normas que organizam a prática e definem o que e permitido",
        why: "elas garantem ordem, segurança e comparacao justa"
      },
      {
        lead: "a arbitragem",
      ...
      },
      {
        ...
        answer: "uma ação que infringe regra prevista na modalidade",
        why: "ela gera interrupcao, advertencia ou outra penalidade"
      },
      {
        lead: "a penalidade",
        answer: "a consequência aplicada quando ocorre infração regulamentar",
        why: "penalidades ajudam a manter a justica da disputa"
      },
      {
        lead: "o conhecimento do regulamento",
        answer: "uma condição importante para participar com autonomia e respeito",
        why: "entender as regras melhora a tomada de decisão no jogo"
      }
    ]
  },
  {
    subtopico: "Aquecimento e segurança",
    habilidade:
      "aplicar princípios de segurança no esporte",
    ...
    fatos: [
      ...
      },
      {
        ...
        answer: "o conjunto de cuidados adotados para reduzir riscos na prática esportiva",
        why: "orientacoes, técnica e materiais adequados protegem o praticante"
      },
      {
        lead: "o equipamento adequado",
        answer: "o material compatavel com a modalidade e com a segurança do aluno",
        why: "calcados e implementos corretos diminuem risco de acidentes"
      },
      {
        lead: "a hidratação",
        answer: "a reposição de líquidos perdida durante a atividade",
        why: "ela ajuda a manter o funcionamento adequado do organismo"
      },
      {
        lead: "o alongamento orientado",
        answer: "uma prática que pode integrar a preparacao e o retorno a calma",
        why: "quando bem conduzido, contribui para conforto e consciência corporal"
      }
    ]
  },
  {
    subtopico: "Técnica e tática inicial",
    habilidade:
      "compreender regras e técnicas fundamentais",
    tags: ["tecnica", "tatica", "estrategia"],
    fatos: [
      {
        lead: "a técnica esportiva",
        answer: "o modo de executar corretamente um gesto da modalidade",
        why: "ela busca eficiencia, controle e adequacao"
      },
      {
        lead: "a tática",
        answer: "a escolha de ações para responder a situações do jogo",
        why: "ela relaciona decisão, objetivo e contexto da disputa"
      },
      {
        lead: "a leitura do jogo",
        answer: "a capacidade de perceber espacos, adversarios e oportunidades",
        why: "essa leitura favorece decisões mais adequadas"
      },
      {
        lead: "a combinacao ofensiva",
        answer: "a articulação entre jogadores para criar chance de pontuar",
        why: "ela depende de coordenação e entendimento coletivo"
      },
      {
        lead: "a cobertura defensiva",
        answer: "o apoio dado por um jogador para proteger espaco ou companheiro",
        why: "ela fortalece a organização da equipe"
      }
    ]
  },
  {
    subtopico: "Ética esportiva e fair play",
    habilidade:
      "reconhecer a importancia da ética esportiva",
    tags: ["ética esportiva", "fair play", "respeito"],
    fatos: [
      {
        lead: "o fair play",
        answer: "a conduta baseada em respeito, honestidade e lealdade na prática esportiva",
        why: "ele valoriza a justica do jogo acima da vantagem indevida"
      },
      {
        lead: "o respeito ao adversario",
        answer: "uma atitude ética essencial em qualquer disputa esportiva",
        why: "competir não significa desvalorizar ou agredir o outro"
      },
      {
        lead: "a cooperação na equipe",
        answer: "a disposição para atuar em favor do objetivo comum",
        why: "mesmo em ambiente competitivo, a equipe depende de colaboracao"
      },
      {
        lead: "a rejeicao a trapaca",
        answer: "o compromisso de não buscar vantagem por meios irregulares",
        why: "a ética esportiva e incompativel com fraude e desrespeito"
      },
      {
        lead: "a responsabilidade do praticante",
        answer: "o dever de agir com autocontrole e respeito as normas",
        why: "o comportamento do atleta também educa e influencia o grupo"
      }
    ]
  }
];
