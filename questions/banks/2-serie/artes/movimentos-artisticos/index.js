...
const blocos = [
  {
    ...
    fatos: [
      { lead: "o movimento que retomou o mundo classico e o valor do humano", answer: "o Renascimento", why: "ele uniu racionalidade, observação e referencias antigas" },
      { lead: "a valorizacao do ser humano e da experiencia terrena nas artes", answer: "o Humanismo", why: "ele redefiniu temas e enfoques da representação" },
      { lead: "a técnica de profundidade matemática tipica do periodo", answer: "a perspectiva linear", why: "ela ampliou a ilusao espacial da pintura" },
      { lead: "a busca por equilíbrio e proporção nas obras", answer: "a harmonia clássica", why: "ela foi central para o ideal renascentista" },
      { lead: "a articulação entre arte, ciencia e anatomia na imagem", answer: "o naturalismo renascentista", why: "ele aproximou observação e representação" }
    ]
  },
  {
    subtopico: "Barroco",
    ...
    fatos: [
      ...
      { lead: "a composição repleta de movimento e diagonais", answer: "o dinamismo barroco", why: "ele rompeu com a serenidade clássica" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a exaltacao do individuo e da experiencia interior", answer: "o subjetivismo romantico", why: "ele é uma marca importante do movimento" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a recusa do sentimentalismo excessivo do romantismo", answer: "a objetividade realista", why: "ela buscou observação mais direta da realidade" },
      { lead: "a representação de pessoas comuns como assunto digno de arte", answer: "a valorizacao do cotidiano", why: "ela ampliou o repertorio de temas artisticos" },
      { lead: "a relação entre arte e crítica da sociedade burguesa", answer: "a perspectiva realista", why: "ela tornou a obra um campo de observação social" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o movimento interessado em luz instantanea e percepcao visual", answer: "o Impressionismo", why: "ele renovou cor, pincelada e relação com o tempo" },
      ...
      { lead: "a pintura ao ar livre para captar mudanças atmosfericas", answer: "o en plein air", why: "ele ajudou a consolidar a experiencia impressionista" },
      { lead: "a utilizacao emotiva e intensa da cor por Van Gogh", answer: "a subjetividade cromatica", why: "ela é uma marca pos-impressionista" },
      { lead: "a construção estrutural da forma investigada por Cezanne", answer: "a organização geometrica da pintura", why: "ela influenciou fortemente o cubismo" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a cor usada por sua força emotiva mais que por fidelidade ao visível", answer: "a cor arbitraria", why: "ela é um recurso marcante do Fauvismo" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "o movimento que fragmentou a forma em vários pontos de vista", answer: "o Cubismo", why: "ele modificou profundamente a representação do espaco" },
      ...
      { lead: "a relação desses movimentos com a ideia de ruptura e vanguarda", answer: "a experimentacao radical", why: "ela define o papel historico dessas correntes" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "o objeto cotidiano deslocado para o campo artístico", answer: "o ready-made", why: "ele redefiniu a nocao de autoria e obra" },
      { lead: "a criação de imagens improvaveis e ilogicas", answer: "a associacao surreal", why: "ela rompe com a ordem racional do visível" },
      { lead: "a vontade de desmontar certezas sobre o que pode ser arte", answer: "a crítica de linguagem", why: "ela une Dadaismo e varias pesquisas modernas" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a corrente abstrata de base racional e geometrica", answer: "a abstracao geometrica", why: "ela valoriza construção e regularidade formal" },
      ...
      { lead: "a arte orientada por organização racional e função social da forma", answer: "o construtivismo", why: "ele aproximou arte, projeto e sociedade" },
      { lead: "a autonomia de linha, cor e plano sem referencia figurativa", answer: "a linguagem não figurativa", why: "ela esta na base de varias vertentes abstratas" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o marco de renovação artística realizado em São Paulo em 1922", answer: "a Semana de Arte Moderna", why: "ela consolidou simbolicamente o modernismo no Brasil" },
      { lead: "a proposta de reelaborar referencias estrangeiras a partir da cultura local", answer: "a antropofagia", why: "ela formulou estrategia crítica de criação brasileira" },
      { lead: "a relação entre vanguardas europeias e temas nacionais no Brasil", answer: "a adaptacao modernista brasileira", why: "ela não copiou modelos externos de forma passiva" },
      { lead: "a busca de identidade cultural por meio da experimentacao formal", answer: "o projeto modernista", why: "ele articulou arte, linguagem e interpretação do país" },
...
export const movimentosArtisticos = {
  ...
  metadados: {
    ...
    habilidadesBase: [
      ...
      "interpretar permanencias e mudanças na história da arte"
    ],
    auditado: true,
