...
const blocos = [
  {
    subtopico: "Contexto da modernidade artistica",
    habilidade: "identificar-contextos-e-rupturas-da-arte-moderna",
    tags: ["artes", "arte-moderna"],
    fatos: [
      { lead: "o periodo de intensas transformacoes urbanas e tecnicas entre seculos XIX e XX", answer: "a modernidade", why: "ela alterou temas, ritmos e linguagens da arte" },
      ...
      { lead: "a presenca de cidade, industria e velocidade no imaginario artistico", answer: "o tema da vida moderna", why: "ele se tornou frequente nas vanguardas" },
      { lead: "a experimentacao formal em lugar da mera imitacao da natureza", answer: "a pesquisa de linguagem", why: "ela e central para compreender a arte moderna" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a pincelada curta e visivel caracteristica do movimento", answer: "a pincelada fragmentada", why: "ela ajuda a construir vibracao luminosa na tela" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "o conjunto de pesquisas que ampliou ou tensionou o impressionismo", answer: "o Pos-impressionismo", why: "ele nao foi um bloco unico, mas um campo de desdobramentos" },
      { lead: "o uso expressivo e emocional de cor intensa nas obras de Van Gogh", answer: "a cor subjetiva", why: "ela rompe com a mera observacao objetiva do visivel" },
      { lead: "a construcao da forma por planos e estrutura em Cezanne", answer: "a sintese geometrica", why: "ela influenciou fortemente movimentos posteriores" },
      ...
      { lead: "a pesquisa de pontos cromaticos de Seurat", answer: "o pontilhismo", why: "ela combinou cor e metodo de observacao optica" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "o grupo que explorou cor intensa e arbitraria no inicio do seculo XX", answer: "o Fauvismo", why: "ele libertou a cor de funcao puramente naturalista" },
      { lead: "a obra O grito associada a angustia existencial moderna", answer: "Edvard Munch", why: "sua producao se tornou referencia expressionista" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "o artista associado a Les Demoiselles d Avignon", answer: "Pablo Picasso", why: "ele e uma das figuras centrais do cubismo" },
      { lead: "a exploracao de formas geometricas na representacao de objetos", answer: "a geometrizacao da forma", why: "ela e um principio essencial do movimento" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "o uso de objetos cotidianos deslocados para o campo artistico", answer: "o ready-made", why: "ele ampliou radicalmente a nocao de obra de arte" },
      { lead: "o artista associado a Fonte e aos ready-mades", answer: "Marcel Duchamp", why: "sua producao redefiniu os limites da arte moderna" },
      { lead: "a intencao de escandalizar e interromper expectativas do publico", answer: "a provocacao vanguardista", why: "ela foi um recurso importante desses movimentos" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o movimento que explorou sonho, automatismo e inconsciente", answer: "o Surrealismo", why: "ele buscou superar a logica racional da representacao" },
      { lead: "a influencia das ideias de Freud sobre desejos e inconsciente", answer: "a base psiquica do surrealismo", why: "ela ajudou a orientar imagens estranhas e oniricas" },
      ...
      { lead: "a criacao de imagens improvaveis e ilogicas em uma mesma cena", answer: "a associacao onirica", why: "ela rompe com o funcionamento comum da realidade visual" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "a arte que nao depende de representar objetos reconheciveis", answer: "o Abstracionismo", why: "ela organiza formas, cores e linhas como valores autonomos" },
      ...
      { lead: "a vertente baseada em ordem, geometria e construcao racional", answer: "a abstracao geometrica", why: "ela valoriza regularidade e estrutura" },
      { lead: "o artista frequentemente lembrado como pioneiro da abstracao", answer: "Kandinsky", why: "ele associou musica, espiritualidade e linguagem nao figurativa" },
      { lead: "a organizacao da obra por relacoes de forma e cor independentes do objeto", answer: "a autonomia visual", why: "ela e central para compreender a pintura abstrata" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o evento simbolico de renovacao artistica ocorrido em 1922", answer: "a Semana de Arte Moderna", why: "ela se tornou marco do modernismo brasileiro" },
      ...
      { lead: "a proposta de devorar referencias externas e recria-las localmente", answer: "a antropofagia", why: "ela formulou uma leitura critica da cultura brasileira" },
      { lead: "a valorizacao de temas nacionais e linguagem renovada", answer: "o projeto modernista brasileiro", why: "ele buscou reinterpretar identidade e cultura do pais" },
      { lead: "a ruptura com modelos academicos em favor de experimentacao", answer: "a renovacao estetica de 1922", why: "ela ampliou repertorios artistico e cultural no Brasil" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "a arquitetura que valorizou funcionalidade, linhas simples e novos materiais", answer: "a arquitetura moderna", why: "ela redefiniu relacao entre forma, uso e tecnica" },
      { lead: "a escola alema associada a design, arte e industria", answer: "a Bauhaus", why: "ela aproximou criacao artistica e producao moderna" },
      ...
      { lead: "o arquiteto frequentemente ligado a lema menos e mais", answer: "Mies van der Rohe", why: "ele e referencia de sintese formal moderna" },
      { lead: "a aproximacao entre estetica, funcao e vida cotidiana no design", answer: "o design moderno", why: "ele buscou integrar beleza, uso e reproducao industrial" }
    ]
  }
];
...
export const arteModerna = {
  ...
  metadados: {
    ...
    subtopicosBase: [
      "Contexto da modernidade artistica",
      "Impressionismo",
      "Pos-impressionismo",
    ...
    habilidadesBase: [
      ...
      "reconhecer caracteristicas e artistas das principais vanguardas",
      ...
      "analisar a presenca da modernidade em arquitetura e design"
    ],
    auditado: true,
