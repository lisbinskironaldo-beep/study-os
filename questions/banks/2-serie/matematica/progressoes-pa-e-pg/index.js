...
const blocos = [
  {
    ...
    tags: ["pa", "conceitos"],
    fatos: [
      { lead: "uma progressao aritmetica", answer: "a sequencia em que a diferença entre termos consecutivos e constante", why: "essa regularidade define a PA" },
      ...
      { lead: "uma PA decrescente", answer: "a progressao cuja razao e negativa", why: "cada novo termo reduz o valor anterior na mesma diferença" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a diferença entre a_n e a_1", answer: "o resultado do produto entre n menos 1 e a razao", why: "isso mede o afastamento em relação ao inicio da PA" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a média entre primeiro e ultimo termo na PA", answer: "o valor que representa o termo medio da soma pareada", why: "a formula de soma usa essa simetria" },
      { lead: "o metodo de Gauss para somar uma PA", answer: "a estrategia de parear termos extremos que produzem a mesma soma", why: "essa observação justifica a formula de soma" },
      ...
      { lead: "a utilizacao da soma da PA", answer: "o calculo de acumulados em sequencias com variação aditiva constante", why: "esse tipo de problema aparece em contextos numericos e financeiros simples" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "uma PG crescente com termos positivos", answer: "a progressao cuja razao e maior que 1", why: "nessa situação os valores aumentam por multiplicacao" },
      ...
      { lead: "a diferença principal entre PA e PG", answer: "o fato de uma variar por soma constante e a outra por multiplicacao constante", why: "essa distincao organiza todo o estudo das progressoes" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a comparacao entre termos distantes de uma PG", answer: "um caso em que a potencia da razao se torna decisiva", why: "o afastamento depende do número de etapas multiplicativas" },
  ...
  },
  {
    ...
    fatos: [
      ...
      { lead: "a soma infinita de uma PG", answer: "o calculo possível apenas quando o modulo da razao e menor que 1", why: "nessa situação os termos tendem a zero" },
      ...
      { lead: "o uso da soma da PG", answer: "a modelagem de acumulados com variação multiplicativa constante", why: "isso ocorre em financiamentos, crescimento e fenomenos naturais" }
    ]
  },
  {
    ...
    fatos: [
      { lead: "o comportamento de uma PA", answer: "a evolucao linear baseada em diferença constante", why: "cada termo se afasta do anterior por soma ou subtracao fixa" },
      ...
      { lead: "um problema de parcelas iguais sucessivas", answer: "um contexto mais associado a PA", why: "a variação e aditiva e regular" },
      { lead: "um problema de crescimento percentual sucessivo", answer: "um contexto mais associado a PG", why: "a variação ocorre por fatores multiplicativos" },
      { lead: "a escolha entre PA e PG", answer: "a análise de se a variação e por diferença ou por razao constante", why: "essa leitura define o modelo adequado" }
    ]
  },
  {
    subtopico: "Aplicacoes financeiras",
    habilidade: "relacionar progressoes a situações financeiras e cotidianas",
    tags: ["aplicacoes", "financeiro"],
    fatos: [
      { lead: "o parcelamento com acrescimos fixos", answer: "um exemplo de comportamento aproximado de PA", why: "o aumento se repete por uma mesma diferença" },
      ...
      { lead: "uma poupanca com depositos crescentes sempre pelo mesmo valor", answer: "uma situação modelada por PA", why: "a variação dos depositos e aditiva" },
      { lead: "um investimento com rendimento percentual constante", answer: "uma situação modelada por PG", why: "o capital cresce por multiplicacao sucessiva" },
      { lead: "a interpretação de tabelas sequenciais", answer: "uma estrategia para detectar se os dados sugerem PA ou PG", why: "a observação da diferença ou da razao ajuda a classificar a sequencia" }
    ]
  },
  {
    ...
    fatos: [
      ...
      { lead: "a descoberta da razao a partir de dois termos", answer: "uma etapa que reconstrui a regra de formação da progressao", why: "a sequencia pode ser determinada por seus elementos e sua regularidade" },
      { lead: "a identificacao do termo medio em uma PA", answer: "a equivalencia com a média aritmetica entre extremos equidistantes", why: "a linearidade da PA garante essa propriedade" },
      { lead: "a identificacao do termo medio em uma PG positiva", answer: "a equivalencia com a média geometrica entre extremos equidistantes", why: "a multiplicacao regular da PG sustenta essa relação" },
  ...
  },
  {
    ...
    fatos: [
      { lead: "a traducao de uma fila de assentos em fileiras crescentes", answer: "um contexto que frequentemente gera PA", why: "o aumento por fileira costuma ocorrer por diferença fixa" },
      ...
      { lead: "a verificacao do modelo adotado", answer: "a comparacao entre a variação observada e o padrao de PA ou PG", why: "escolher o modelo certo e essencial antes do calculo" },
      { lead: "a leitura do resultado num problema sequencial", answer: "a associacao do valor encontrado ao número de termos ou ao total pedido", why: "a resposta deve respeitar a pergunta do contexto" },
      { lead: "a interpretação final em problemas de progressoes", answer: "a etapa de explicar o significado do termo ou da soma obtida", why: "resolver vai alem de aplicar formulas isoladamente" }
    ]
  }
];
